 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Jong Yoon Kim");
		  toPrint += p1.toString("903307154");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Gabe");
		  toPrint += p2.toString("903022571");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Caleb");
		  toPrint += p3.toString("903209924");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("David");
                  toPrint += p4.toString("903217019");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Edward Chiao");
                  toPrint += p5.toString("903192809");
